                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-6 pt-4">
                      <Dialog>
                        ...
                        <DialogPortal>
                          ...
                          <DialogContent className="fixed left-1/2 top-1/2 max-h-[70vh] w-full max-w-2xl sm:max-w-3xl -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-background p-6 sm:p-10 shadow-xl focus:outline-none z-50 animate-scale-in overflow-y-auto mx-2 sm:mx-0">
                            ...
                            <div className="text-muted-foreground whitespace-pre-line text-base sm:text-lg leading-relaxed">
                              {article.content}
                            </div>
                          </DialogContent>
                        </DialogPortal>
